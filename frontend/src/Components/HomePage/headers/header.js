    ...
    <div className={classes.mainhead}>
      <div className={classes.navbar}>
        ...
        <div className={classes.profilecheckout}>
          ...
          <div className={classes.profiletext}>
            <p style={{ fontSize: "14px" }}>Login Here</p>
            <h4 style={{ fontSize: "18px" }}>My Account</h4>
          </div>
          <div className={classes.cart}>
            {" "}
            <Link to={"/cart"}>
              <AddShoppingCartIcon sx={{ fontSize: "50px", color: "black" }} />
            </Link>
          </div>
          <div className={classes.carttext}>
            <p style={{ fontSize: "14px" }}>Shopping Cart</p>
            <h4 style={{ fontSize: "18px" }}>Checkout</h4>
          </div>
        </div>
      </div>
      <hr />
      <div className={classes.navbar1} id="menu-bar">
        <ul className={classes.itemlist} style={{ textDecoration: "none" }}>
          ...
          <li>
            Pages
            <KeyboardArrowDownRoundedIcon style={{ marginBottom: "-7px" }} />
