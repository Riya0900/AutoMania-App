...
function ShopPage(cart) {
  ...
  const [noOfPages] = useState(Math.ceil(categories.length / itemsPerPage));
            ...
            <Grid item xs={3}>
              <Item className={classes.col1}>
                ...
                <div className={classes.filter}>
                  ...
                  />
                  <div>
                    <p className={classes.filterprice}>
                      {" "}
                      Price: {valueLabelFormat(calculateValue(value1, value2))}
                    </p>
                  ...
                  {product &&
                    product.map((p) => (
                      <div className={classes.pro}>
                        ...
                        <p className={classes.recent_proname}>
                          {p.d1}
                          <br />
                          {p.d2}
                        </p>
                  ...
                  .map((c) => {
                    return (
                      <div className={classes.cat}>
                        ...
                        <Box sx={{ display: "inline-block", maxWidth: "7vw" }}>
                          <Rating
                            name="read-only"
                            defaultValue={c.rate}
                            precision={c.precise}
