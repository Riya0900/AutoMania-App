...
import useAboutus from "./Aboutusstyle";
import { useTheme } from "@mui/material/styles";
import { useSpring, animated } from "react-spring";
import Img11 from "./photos/img1.jpg";
import Img22 from "./photos/img2.jpg";
...
const imagesHp = [
  {
    head1: "John Alex",
    para1:
      "This division is not obsolete but has changed. Natural philosophy has split into the various natural sciences, especially astronomy, and cosmology. Moral philosophy has birthed the social sciences, but still includes value theory.",
    para2: "CEO Mabelya",
    imaged: Img11,
  },
  {
        ...
        <div className={classes.mainabout}>
                ...
                <div className={classes.right_para}>
                  <div className={classes.right_para1}>
                    <Typography variant="p" className={classes.para1}>
                      The more we drive the car the better they seem to operate
                      operate. No noise, just stopping power! Quis autem vel eum
                  ...
                  <div className={classes.right_para2}>
                    <Typography variant="p" className={classes.para1}>
                      ...
                      pariatur erit qui in ea voluptate verit qui in ea
                      voluptate vele.{" "}
                    </Typography>
                  </div>
                </div>
                <div>
                  <Button variant="contained" className={classes.right_btn}>
                    Learn More{" "}
                  </Button>
                </div>
              </div>
          ...
          <div className={classes.div_image}>
            <div className={classes.left_image}>
              <img
                className={classes.set_image}
                src="https://themebing.com/wp/sayara/wp-content/uploads/2020/05/car.png"
                alt="carlogo"
              ></img>
            </div>
          </div>
          ...
          <div className={classes.div_numbers}>
            <div className={classes.common_num}>
              <div className={classes.number}>
                <animated.h1 className={classes.incr_number}>
                  {props1.val.to((val) => Math.floor(val))}
                </animated.h1>
            ...
            <div className={classes.common_num}>
              <div className={classes.number}>
                <animated.h1 className={classes.incr_number}>
                  {props2.val.to((val) => Math.floor(val))}
                </animated.h1>
                <div className={classes.para_bottom}>
            ...
            <div className={classes.common_num}>
              <div className={classes.number}>
                <animated.h1 className={classes.incr_number}>
                  {props3.val.to((val) => Math.floor(val))}
                </animated.h1>
                <div className={classes.para_bottom}>
            ...
            <div className={classes.common_num}>
              <div className={classes.number}>
                <animated.h1 className={classes.incr_number}>
                  {props4.val.to((val) => Math.floor(val))}
                </animated.h1>
                <div className={classes.para_bottom}>
        ...
        <div className={classes.last_section}>
          <div className={classes.div_section}>
            <div className={classes.write_top}>
              <Typography variant="h1" className={classes.write_top_head}>
                Testimonials
              </Typography>
              <Typography variant="p" className={classes.write_top_para}>
                During our work we have accumulated hundreds of positive
                reviews.
              </Typography>
            </div>
            ...
            <div className={classes.write_bottom}>
              <div className={classes.img_star}>
                <div className={classes.class_img}>
                  <img
                    className={classes.photo_img}
                    src={imagesHp[activeStep].imaged}
                    alt="photo_img"
                  />
                </div>
                              ...
                              <div className={classes.hp_star}>
                                <div className={classes.hp}>
                                  <div className={classes.sub_hp1}>
                                    <Typography
                                      variant="h4"
                                      className={classes.sub_hp1_head}
                                    >
                                      {step.head1}
                                    </Typography>
                                  </div>
                                  ...
                                  <div className={classes.sub_hp2}>
                                    <Typography
                                      variant="p"
                                      className={classes.sub_hp2_para}
                                    >
                                      {step.para2}
                                    </Typography>
                                  </div>
