    ...
    <>
      <div className={classes.container}>
        <div className={classes.termcon}>
          <DoubleArrowIcon className={classes.icon1} />{" "}
          <Typography variant="p">
            Last updated: June 01, 2020 Please read these terms and conditions
          ...
          <ul className={classes.termul}>
            ...
            <li>
              ...
              <Typography variant="p">
                ...
                this Agreement) refers to AutoMax.{" "}
              </Typography>
            </li>
            <li>
              <strong>Country</strong>{" "}
              <Typography variant="p">
                refers to: Alabama, United States{" "}
              </Typography>
            </li>
            <li>
            ...
            <li>
              ...
              <Typography variant="p">refers to the Website. </Typography>
            </li>
            <li>
              ...
              <Typography variant="p">
                ...
                the use of the Service. This Terms and Conditions agreement has
                been created with the help of the{" "}
                <a
                  href="https://themebing.com/wp/automax"
                  target="_blank"
          ...
          <DoubleArrowIcon className={classes.icon1} />{" "}
          <Typography variant="p"></Typography>These are the Terms and
          ...
          <Typography variant="p">
            ...
            contact us: By email: example@mail.com
          </Typography>
        </div>
      </div>
    </>
